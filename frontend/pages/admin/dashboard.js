          ...
          {navigationItems.map((item) =>
            item.items ? (
                  ...
                  <div className="absolute left-0 mt-2 w-48 bg-zinc-800 text-white shadow-lg rounded-md z-50">
                    {item.items.map((subItem) => (
                      <button
                        ...
                        className={`block px-4 py-2 text-sm hover:bg-blue-500 hover:text-white w-full text-left ${
                          view === subItem.view ? 'bg-blue-600' : 'text-gray-400'
                        }`}
                      >
              ...
              <button
                ...
                className={`flex items-center space-x-3 hover:text-blue-500 transition duration-300 ${
                  view === item.view ? 'text-blue-500' : 'text-gray-400'
                }`}
              >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-zinc-900 border-t border-gray-700 shadow-lg flex justify-around py-2">
        <button
          ...
          className={`text-center transition-transform transform hover:scale-110 ${
            view === 'overview' ? 'text-blue-500' : 'text-gray-400'
          }`}
        >
        ...
        <button
          ...
          className={`text-center transition-transform transform hover:scale-110 ${
            view === 'stock' ? 'text-blue-500' : 'text-gray-400'
          }`}
        >
        ...
        <button
          ...
          className={`text-center transition-transform transform hover:scale-110 ${
            view === 'financiamentos' ? 'text-blue-500' : 'text-gray-400'
          }`}
        >
        ...
        <button
          ...
          className={`text-center transition-transform transform hover:scale-110 ${
            view === 'mensagens' ? 'text-blue-500' : 'text-gray-400'
          }`}
        >
        ...
        <button
          ...
          className={`text-center transition-transform transform hover:scale-110 ${
            view === 'consultafipe' ? 'text-blue-500' : 'text-gray-400'
          }`}
        >
