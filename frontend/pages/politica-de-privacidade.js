...
const PoliticaDePrivacidade = () => {
  ...
  useEffect(() => {
    if (settings) {
      setSEO({
        title: `${settings.name} - Política de Privacidade`,
      });
    }
  }, [settings]);
          ...
          <>
            <section className="mb-10">
              <p className="text-lg text-gray-700 mb-4">
                Nós, da {settings.name}, estamos comprometidos em garantir e preservar a sua privacidade. O propósito desta Política de Privacidade é esclarecer como nós coletamos, usamos e armazenamos seus dados, assim como de que forma manipulamos e utilizamos essas informações.
              </p>
            ...
            <section className="mb-10">
              ...
              <p className="text-lg text-gray-700 mb-4">
                Poderão ver suas informações pessoais apenas funcionários da empresa {settings.name} e empresas parceiras para comunicações, dentre estes, somente as pessoas com as devidas autorizações. Nenhum dado pessoal poderá ser divulgado publicamente.
              </p>
            </section>
            ...
            <section className="mb-10">
              ...
              <p className="text-lg text-gray-700 mb-4">
                Você pode optar por não receber mais qualquer tipo de e-mail da {settings.name}. Em todos os e-mails que enviamos há um link para excluir a assinatura disponível. Todos os dados coletados serão excluídos de nossos servidores quando você assim requisitar ou quando estes não forem mais necessários.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-lg text-gray-700">
                Qualquer dúvida em relação à nossa Política de Privacidade pode ser esclarecida entrando em contato conosco. Envie um e-mail para {settings.email}.
              </p>
            </section>
          </>
        )}
